...
{
    /// <summary>
    ///  to be used for survey listing
    /// </summary>
    public class FragmentSurvey : SupportFragment
    {
        List<MessageHeadersViewModel> _values = new List<MessageHeadersViewModel>();
        public FragmentSurvey(ResponseConversationHeaders DataItems)
        {
        ...
        private void SetUpRecyclerView(RecyclerView recyclerView)
        {
            ...
            recyclerView.SetItemClickListener((rv, position, view) =>
            {
                ...
                Intent intent = new Intent(context, typeof(SurveyDetailActivity));
